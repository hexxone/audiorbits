Questo sfondo utilizza WebGL, WebAudio e un algoritmo frattale per la generazione di "orbite". Risponde alla musica proiettando lo spettro audio in termini di colore, saturazione e luminosità sulle "orbite".
